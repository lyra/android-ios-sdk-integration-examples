...
object Config {
    ...
    const val SERVER_URL = "https://server-sdk-inte-demo.lyra-labs.fr" // without / at the end, example https://myserverurl.com

    // FIXME: Change by the right REST API Server Name (available in merchant BO: Settings->Shop->REST API Keys)
    const val API_SERVER_NAME = "https://api.payzen.eu" // without / at the end, example https://myapiservername.com

    // FIXME: change by your public key
    const val PUBLIC_KEY = "96964545:testpublickey_vBimvlf1vygdNEsuZwkdqOXZjdN9GvGDnKh0JFSzCEqbN"
